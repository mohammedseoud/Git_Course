        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppartmentAddress = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientInfo_City_CityId",
                        column: x => x.CityId,
                        principalSchema: "dbo",
                        principalTable: "City",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientInfo_Client_ClothId",
                        column: x => x.ClothId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientInfo_CityId",
                schema: "dbo",
                table: "ClientInfo",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientInfo_ClothId",
                schema: "dbo",
                table: "ClientInfo",
                column: "ClothId");

...
namespace ElBayt.Infra.Migrations
{
    ...
    [Migration("20221020211046_RemoveImagesFk1")]
    partial class RemoveImagesFk1
    {
            ...
            modelBuilder.Entity("ElBayt.Core.Models.ClothModel", b =>
                {
                    ...
                    b.Property<int?>("ClothCategoriesId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ElBayt.Core.Models.ClothModel", b =>
                {
                    b.HasOne("ElBayt.Core.Models.ClothCategoryModel", "ClothCategories")
                        .WithMany()
                        .HasForeignKey("ClothCategoriesId");

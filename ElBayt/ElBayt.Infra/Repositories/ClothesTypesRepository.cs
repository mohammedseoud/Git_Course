...
{
    public class ClothTypeRepository : GenericRepository<ClothTypeModel, Guid>, IClothTypeRepository
    {
        ...
        public async Task<ClothTypeModel> GetClothTypeByName(string Name, Guid Id)
        {
